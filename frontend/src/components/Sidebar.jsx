...
const BillingIcon = ({ className = 'w-6 h-6' }) => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M7 3h10a1 1 0 0 1 1 1v16l-2.5-1.5L13 20l-2.5-1.5L8 20l-2.5-1.5L3 20V4a1 1 0 0 1 1-1h3Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M8 7h8M8 10h8M8 13h6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
  ...
  return (
    <div className="w-[84px] bg-gradient-to-b from-white to-gray-50 border-r flex flex-col items-center py-4">
      <div className="w-12 h-12 rounded-xl overflow-hidden shadow mb-5 ring-1 ring-gray-200">
        <img src={getAssetPath("/PUWASA LOGO.jpg")} alt="Logo" className="w-full h-full object-cover" />
      </div>
        ...
        {menuItems.map((item, index) => {
          ...
          return (
            <button
              ...
              className={`group relative flex items-center justify-center w-12 h-12 rounded-xl border transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${active
